// Community-maintained Bambu Lab print_error / HMS code -> description lookup.
// Source: https://github.com/suchmememanyskill/bambu-error-codes (derived from
// https://github.com/greghesp/ha-bambulab). NOT an official Bambu Lab resource -
// it's reverse-engineered from the app/Studio UI strings, so it has gaps (see
// https://github.com/greghesp/ha-bambulab/issues/525 for a known missing code).
// Keys are "XXXX_XXXX" (uppercase hex, 4+4 digits) derived from the 32-bit
// print_error value the printer reports. Empty-string values mean the source
// UI shows no text for that code either - treated as "no description" here too.
export const BAMBU_ERROR_CODES: Record<string, string> = {
  ...
  '0701_8005': 'The AMS failed to send filament. You can clip the end of your filament flat, and reinsert. If this message persists, please check the PTFE tubes in AMS for any signs of wear and tear.',
...
// Known filament-run-out codes across the various feed paths (external spool
// and each AMS unit/slot variant). Used as the default for
// filamentRunoutErrorCodes - still overridable/extendable per-printer via config.
export const KNOWN_FILAMENT_RUNOUT_CODES = [
  '0300_8015',
  '0300_8004',
  '0700_8011',
  '0701_8011',
